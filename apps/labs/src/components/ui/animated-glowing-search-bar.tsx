  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="glow-spin absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[314px] rounded-xl blur-[3px]
                        ...
                        before:animate-[spin-slow_7s_linear_infinite]">
        </div>
        <div className="glow-spin absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px]
                        ...
                        before:animate-[spin-slow_9s_linear_infinite]">
        </div>
        <div className="glow-spin absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px]
                        before:absolute before:content-[''] before:z-[-2] before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg]
                        before:bg-[conic-gradient(rgba(0,0,0,0),#18116a,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#6e1b60,rgba(0,0,0,0)_60%)]
        ...
        <div className="glow-spin absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[307px] rounded-lg blur-[2px]
                        ...
                        before:animate-[spin-slow_6s_linear_infinite]">
        </div>

        <div className="glow-spin absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[303px] rounded-xl blur-[0.5px]
                        ...
                        before:animate-[spin-slow_5s_linear_infinite]">
        </div>
        ...
        <div id="main" className="relative group">
          <input
            ...
            type="text"
            name="text"
            className="bg-[#010201] border border-white/10 w-[301px] h-[56px] rounded-lg text-white px-[59px] text-lg focus:outline-none placeholder-gray-400"
          />
          ...
          <div className="glow-spin absolute h-[42px] w-[40px] overflow-hidden top-[7px] right-[7px] rounded-lg
                          ...
                          before:brightness-[1.35] before:animate-[spin-slow_4s_linear_infinite]">
          </div>
